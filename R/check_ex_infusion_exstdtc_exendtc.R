#' @title Check that an  drug has same start/end exposure dates, also including missing start/end dates
#'
...
#'   EXROUTE = "INTRAVENOUS",
#'   EXSTDTC = c(
#'     "2017-01-01", "2017-01-02", "2017-01-01T14:36", "2015", "2017-02", "2017", "",
#'     "2017", "2017-01-01T14:26", "2017-01-01T14:26", "2017-01-01T14", "2017-01-01T14:26:01"
#'   ),
#'   EXENDTC = c(
#'     "2017-01-01", "2017-01-03", "2017-01-01T14:35", "2017", "2017-01", "2016-01-01", "2000",
    ...
    if (nrow(mydf1) == 0 && nrow(mydf2) == 0) {
      ...
      stackeddf <- stackeddf %>%
        mutate(check_flag = case_when(
          check_stat == "Different Start/End date " ~ "A",
          ...
          check_stat == "Different Start/End date " ~ "E",
